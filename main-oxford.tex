...
\[
\underbrace{E(u)}_{\text{Objective}} + \underbrace{\frac{1}{\alpha} \int_{\Omega} u \ln\left(\frac{u}{v}\right) - (u + v) \, \mathrm{d}x}_{\text{Bregman divergence using Shannon entropy}} \text{ over } K. 
\]
}\vspace{-2ex}
