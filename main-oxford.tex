...
\begin{center}
\textit{
\textbf{Regardless} of the choice or order of approximating spaces for $H^1_g(\Omega)$ and $W$ the discrete solution $\psi_h$ yields a \textbf{latent solution} $\widetilde{u}_h := \exp(\psi_h)$ 
...
\begin{figure}
	...
	\caption{\label{fig:ObstacleMesh}
	 Initial FE meshes for domains $\Omega_\infty$, $\Omega_{2}$ mesh sizes $h = h_\infty, h_2$, respectively.
